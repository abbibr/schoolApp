			...
			<div class="col-12">
			 ...
			 <div class="box">
				<div class="box-header with-border">
                  ...
                  <a href="{{ route('student.group.add') }}" style="float: right;" class="btn btn-rounded btn-info mb-5">Add Student Group</a>
					  ...
					  <table id="example1" class="table table-bordered table-striped">
						...
						<tbody>
							...
							@if($datas->count())
                               ...
                               @endforeach 
                            @else
                                <h3 class="box-title">There is not any student group!</h3>
                            @endif
