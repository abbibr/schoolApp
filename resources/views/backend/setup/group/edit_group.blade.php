                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col">
                                ...
                                <form method="post" action="{{ route('student.group.update', $edit_class->id) }}">
                                    @csrf

                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <h5>Edit Group Name <span class="text-danger">*</span></h5>
                                                <div class="controls">
                                    ...
                                    <div class="text-xs-right">
                                        <input type="submit" class="btn btn-rounded btn-primary" value="Update Group">
                                    </div>
                                </form>
