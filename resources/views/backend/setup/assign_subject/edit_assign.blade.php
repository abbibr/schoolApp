            ...
            <section class="content">
                ...
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="box-title">Edit Assign Subject | {{ $edit_assign[0]->student_class->name }}</h4>
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col">
                                <form method="post"
                                    action="{{ route('assign.subject.update', $edit_assign[0]->class_id) }}">
                                    @csrf
                                                        ...
                                                        <select name="class_id" id="class_id" class="form-control">
                                                            ...
                                                            @foreach ($classes as $class)
                                                                <option value="{{ $class->id }}"
                                                                    {{ $edit_assign[0]->class_id == $class->id ? 'selected' : '' }}>
                                                                    {{ $class->name }}
                                                                </option>
                                                            @endforeach
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-2">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="controls">
                                                                <input type="text" value="{{ $edit->full_mark }}"
                                                                    name="full_mark[]" required class="form-control">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-2">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="controls">
                                                                <input type="text" value="{{ $edit->pass_mark }}"
                                                                    name="pass_mark[]" required class="form-control">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-2">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="controls">
                                                                <input type="text" value="{{ $edit->subjective_mark }}"
                                                                    name="subjective_mark[]" required class="form-control">
                                                            </div>
                                                        </div>
                                                    </div>
